...
describe("ValidatorRules unit tests", () => {
  test("constructor values method", () => {
  ...
  describe("required method", () => {
    test("required validation rule with invalid cases", () => {
    ...
    test("required validation rule with valid cases", () => {
      const arrange: Values[] = [
  ...
  describe("string method", () => {
    test("string validation rule with invalid cases", () => {
      const arrange: Values[] = [
        { value: 5, property: "field" },
        { value: {}, property: "field" },
        { value: false, property: "field" },
    ...
    test("string validation rule with valid cases", () => {
      const arrange: Values[] = [
        { value: null, property: "field" },
        { value: undefined, property: "field" },
        { value: "test", property: "field" },
  ...
  describe("maxLength method", () => {
    test("maxLength validation rule with invalid cases", () => {
      const arrange: Values[] = [{ value: "aaaaaa", property: "field" }];
    ...
    test("maxLength validation rule with valid cases", () => {
      const arrange: Values[] = [
        { value: null, property: "field" },
        { value: undefined, property: "field" },
  ...
  describe("boolean method", () => {
    test("boolean validation rule with invalid cases", () => {
      const arrange: Values[] = [
        { value: 5, property: "field" },
    ...
    test("boolean validation rule with valid cases", () => {
      const arrange: Values[] = [
        { value: null, property: "field" },
        { value: undefined, property: "field" },
        { value: false, property: "field" },
